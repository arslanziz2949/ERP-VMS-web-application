...
const CreateAdminComponent = () => {
    ...
    const { mode } = useTheme(); // Get mode from useTheme
    const theme = useThemeValues(); // Get theme values
        ...
        <div style={{
            ...
            <div style={{
                ...
                <p style={{
                    ...
                    Add a new admin user to your system with profile image and details
                </p>
            </div>
            ...
            <div style={{
                    ...
                    <div style={{
                        ...
                        {!imagePreview && (
                            <div style={{
                                marginTop: '16px',
                                padding: '12px',
                                background: currentStatusColors.info.bg,
                                border: `1px solid ${currentStatusColors.info.border}`,
                                borderRadius: '6px',
                                fontSize: '13px',
                                color: currentStatusColors.info.text,
                                transition: 'all 0.3s ease'
                            }}>
                                <div style={{ fontWeight: '600', marginBottom: '4px' }}>Tips:</div>
                                <div>• Use a clear, professional headshot</div>
                                <div>• Recommended size: 400x400 pixels</div>
                ...
                {/* Right Column - Admin Details Form */}
                <div>
                    <div style={{
                        background: theme.palette.bg.card,
                        borderRadius: '12px',
